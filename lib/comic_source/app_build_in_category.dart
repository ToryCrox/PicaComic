...
const CategoryData jmCategory = CategoryData(
  ...
  categories: [
    ...
    FixedCategoryPart("其它", ['CG', '重口', '獵奇', '非H', '血腥暴力', '站長推薦'], "search"),
  ],
  enableRankingPage: true,
);
...
final nhCategory = CategoryData(
  ...
  key: "nhentai",
  categories: [
    const FixedCategoryPart("language", [
      "chinese",
      "japanese",
      "english",
    ], "search_with_namespace"),
